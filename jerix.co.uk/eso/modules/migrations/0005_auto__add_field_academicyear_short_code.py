...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AcademicYear.short_code'
        db.add_column('modules_academicyear', 'short_code',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AcademicYear.short_code'
        db.delete_column('modules_academicyear', 'short_code')
