...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Module', fields ['short_code']
        db.create_unique('modules_module', ['short_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'Module', fields ['short_code']
        db.delete_unique('modules_module', ['short_code'])
    ...
    models = {
        ...
        'modules.history': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 27, 0, 0)'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'modules.material': {
