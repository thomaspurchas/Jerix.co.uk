...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for module in orm.Module.objects.all():
            module.lecturers = module.lecturers_new.all()

    def backwards(self, orm):
        "Write your backwards methods here."
        for module in orm.Module_old.objects.all():
            module.lecturers_old = module.lecturers.all()
    ...
    models = {
        ...
        'modules.module': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lecturers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['accounts.LecturerProfile']", 'symmetrical': 'False'}),
            'lecturers_new': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'modules'", 'symmetrical': 'False', 'to': "orm['accounts.LecturerProfile']"}),
