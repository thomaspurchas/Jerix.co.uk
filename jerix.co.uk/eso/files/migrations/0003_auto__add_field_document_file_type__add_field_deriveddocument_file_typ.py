...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.file_type'
        db.add_column(u'files_document', 'file_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Adding field 'DerivedDocument.file_type'
        db.add_column(u'files_deriveddocument', 'file_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.file_type'
        db.delete_column(u'files_document', 'file_type')

        # Deleting field 'DerivedDocument.file_type'
        db.delete_column(u'files_deriveddocument', 'file_type')
