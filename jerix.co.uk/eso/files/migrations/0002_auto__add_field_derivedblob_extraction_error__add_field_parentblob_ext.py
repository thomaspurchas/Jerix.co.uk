...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DerivedBlob.extraction_error'
        db.add_column('files_derivedblob', 'extraction_error',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ParentBlob.extraction_error'
        db.add_column('files_parentblob', 'extraction_error',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DerivedBlob.extraction_error'
        db.delete_column('files_derivedblob', 'extraction_error')

        # Deleting field 'ParentBlob.extraction_error'
        db.delete_column('files_parentblob', 'extraction_error')
