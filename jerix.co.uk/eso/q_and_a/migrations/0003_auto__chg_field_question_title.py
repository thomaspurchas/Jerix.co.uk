...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('q_and_a_question', 'title', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Question.title'
        db.alter_column('q_and_a_question', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))
