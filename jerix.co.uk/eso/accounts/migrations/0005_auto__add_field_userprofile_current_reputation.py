...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.current_reputation'
        db.add_column('accounts_userprofile', 'current_reputation',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.current_reputation'
        db.delete_column('accounts_userprofile', 'current_reputation')
