...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('accounts_studentprofile', 'tutor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.LecturerProfile'], null=True))

        # Changing field 'StudentProfile.year'
        db.alter_column('accounts_studentprofile', 'year_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['students.Year'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'StudentProfile.tutor'
        raise RuntimeError("Cannot reverse this migration. 'StudentProfile.tutor' and its values cannot be restored.")
    ...
    models = {
        ...
        'accounts.studentprofile': {
            ...
            'year': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['students.Year']", 'null': 'True', 'blank': 'True'})
        },
